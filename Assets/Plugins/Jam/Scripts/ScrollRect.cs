...
namespace Jam
{
	...
	public class ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup, IEventSystemHandler, ILayoutController
	{
		...
		[SerializeField]
		private Jam.ScrollRect.MovementType m_MovementType = Jam.ScrollRect.MovementType.Elastic;
		...
		[SerializeField]
		private Jam.ScrollRect.ScrollbarVisibility m_HorizontalScrollbarVisibility;

		[SerializeField]
		private Jam.ScrollRect.ScrollbarVisibility m_VerticalScrollbarVisibility;
		...
		[SerializeField]
		private Jam.ScrollRect.ScrollRectEvent m_OnValueChanged = new Jam.ScrollRect.ScrollRectEvent();
		...
		public Jam.ScrollRect.MovementType movementType
		{
			get
			{
		...
		public Jam.ScrollRect.ScrollbarVisibility horizontalScrollbarVisibility
		{
			get
			{
		...
		public Jam.ScrollRect.ScrollbarVisibility verticalScrollbarVisibility
		{
			get
			{
		...
		public Jam.ScrollRect.ScrollRectEvent onValueChanged
		{
			get
			{
...
//		}
		...
		private void UpdateCachedData()
		{
			...
			this.m_HSliderExpand = (flag4 && this.m_HorizontalScrollbarRect && this.horizontalScrollbarVisibility == Jam.ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport);
			this.m_VSliderExpand = (flag4 && this.m_VerticalScrollbarRect && this.verticalScrollbarVisibility == Jam.ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport);
